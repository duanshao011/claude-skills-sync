    ...
    },
    {
        ...
        "columns": [
            ...
            {"key": "uv_cost", "label": "阅读UV成本", "unit": "元", "type": "num",
             "formula": "薯条累计投放金额 / 星河『阅读/播放UV』",
             "meaning": "拉动一个星河阅读/播放用户的付费成本，越低越好（同名字段在薯条组下用蒲公英『阅读UV』做分母，两者口径不同）", "source": "系统计算", "needs": ["薯条"]},
    ...
    },
    {
        ...
        "columns": [
            ...
            {"key": "roi", "label": "ROI", "unit": "", "type": "num",
             "formula": "商家GMV / 累计金额", "meaning": "每花 1 元付费投放带来的成交金额（GMV含多内容归因重复，该值为近似参考）", "source": "系统计算", "needs": ["薯条"]},
