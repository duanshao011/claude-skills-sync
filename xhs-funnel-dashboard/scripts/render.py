...
COLUMN_GROUPS = [
    ...
    },
    {
        ...
        "columns": [
            ...
            {"key": "spend", "label": "投放金额", "unit": "元", "type": "num",
            ...
            {"key": "read_uv_cost", "label": "阅读UV成本", "unit": "元", "type": "num",
             "formula": "投放金额 / 蒲公英阅读UV",
             "meaning": "拉动一个阅读用户的付费成本，越低越好", "source": "系统计算", "needs": ["薯条"]},
    ...
    },
    {
        ...
        "columns": [
            ...
            {"key": "visit_uv_cost", "label": "进店UV成本", "unit": "元", "type": "num",
             "formula": "投放金额 / 进店UV", "meaning": "拉动一个进店用户的付费成本，越低越好", "source": "系统计算", "needs": ["薯条"]},
            ...
            {"key": "cart_cost", "label": "加购成本", "unit": "元", "type": "num",
             "formula": "投放金额 / 加购UV", "meaning": "拉动一个加购用户的付费成本，越低越好", "source": "系统计算", "needs": ["薯条"]},
            {"key": "deal_cost", "label": "成交成本", "unit": "元", "type": "num",
             "formula": "投放金额 / 成交UV", "meaning": "拉动一单成交的付费成本，越低越好", "source": "系统计算", "needs": ["薯条"]},
            {"key": "chili_days", "label": "累计投放天数", "unit": "天", "type": "int",
             "formula": "薯条投放的不同启动日计数", "meaning": "该笔记实际投放的天数（非自然天数，去重启动日）", "source": "薯条"},
            {"key": "roi", "label": "ROI", "unit": "", "type": "num",
             "formula": "商家GMV / 投放金额", "meaning": "每花1元付费投放带来的成交金额", "source": "系统计算", "needs": ["薯条"]},
        ],
    },
    {
        "key": "lx",
